...
public class iShChatAFKOtherCommand implements CommandExecutor {
    iShout plugin;

    public iShChatAFKOtherCommand(iShout plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (cmd.equalsIgnoreCase("iShoutchatafkother")) {
            ...
            if (sender instanceof Player) {
                ...
                if (!plugin.getAPI().checkPermissions(player.getName(), player.getWorld().getName(), "iShout.afk.other")) {
