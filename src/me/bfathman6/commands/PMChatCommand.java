...
public class PMChatCommand implements CommandExecutor {
    ...
    public PMChatCommand(iShout plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (cmd.equalsIgnoreCase("pmchat")) {
            if (!plugin.getAPI().checkPermissions(player.getName(), player.getWorld().getName(), "iShout.pm.pm")) {
            ...
            if (plugin.spoutB) {
                if (plugin.spoutPM) {
                    ...
                    if (sRecipient.isSpoutCraftEnabled()) {
                        ...
                        sRecipient.sendNotification("[iShoutPm] From:", player.getName(), Material.PAPER);
