...
import me.bfathman6.channel.ChannelEditType;
import me.bfathman6.channel.ChannelType;
...
public class iShChannelCommand implements CommandExecutor {
    iShout plugin;

    public iShChannelCommand(iShout plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (cmd.equalsIgnoreCase("iShchannel")) {
            if (!(args.length > 0)) {
            ...
            if (args[0].equalsIgnoreCase("types")) {
                if (!plugin.getAPI().checkPermissions(sender, "iShchannel.types")) {
                    Messanger.sendMessage(sender, "You don't have Permissions for: 'iShchannel.types'.");
                    return true;
                }
                ...
                if (!plugin.getAPI().checkPermissions(sender, "iShchannel.edittypes")) {
                    Messanger.sendMessage(sender, "You don't have Permissions for: 'iShchannel.edittypes'.");
                    return true;
                }
                ...
                if (!plugin.getAPI().checkPermissions(sender, "iShchannel.create." + args[1].toLowerCase())) {
                    Messanger.sendMessage(sender, "You don't have Permissions for: '" + "iShchannel.create." + args[1].toLowerCase() + "'.");
                    return true;
                }
                ...
                if (!plugin.getAPI().checkPermissions(sender, "iShchannel.remove." + args[1].toLowerCase())) {
                    Messanger.sendMessage(sender, "You don't have Permissions for: '" + "iShchannel.remove." + args[1].toLowerCase() + "'.");
                    return true;
                }
            ...
            if (args[0].equalsIgnoreCase("join")) {
                ...
                if (!plugin.getAPI().checkPermissions(sender, "iShchannel.join." + args[1].toLowerCase())) {
                    Messanger.sendMessage(sender, "You don't have Permissions for: '" + "iShchannel.join." + args[1].toLowerCase() + "'.");
                    return true;
                }
                ...
                if (!plugin.getAPI().checkPermissions(sender, "iShchannel.leave." + args[1].toLowerCase())) {
                    Messanger.sendMessage(sender, "You don't have Permissions for: '" + args[1].toLowerCase() + "'.");
                    return true;
                }

                if (plugin.getChannelManager().getChannel(args[1]) == null)
                    Messanger.sendMessage(sender, "No Channel by the name of '" + "iShchannel.leave." + args[1].toLowerCase() + "' could be found.");
