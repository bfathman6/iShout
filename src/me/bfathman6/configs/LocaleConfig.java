...
public class LocaleConfig {
    ...
    public LocaleConfig(iShout plugin) {
        this.plugin = plugin;
        this.config = plugin.iShELocale;
    ...
    public void reload() {
        plugin.iShELocale = YamlConfiguration.loadConfiguration(plugin.iShELocaleF);
    ...
    void defaultLocale() {
        ...
        try {
            config.save(plugin.iShELocaleF);
        } catch (IOException ignored) {}
    }

    public void load() {
        if (!(plugin.iShELocaleF).exists())
            defaultLocale();
