...
public class ChannelConfig {
    ...
    public ChannelConfig(iShout plugin) {
        this.plugin = plugin;

        plugin.iShChConfig.options().indent(4);
    }

    public void reload() {
        plugin.iShChConfig = YamlConfiguration.loadConfiguration(plugin.iShChConfigF);
        plugin.iShChConfig.options().indent(4);
    ...
    void defaultConfig() {
        YamlConfiguration config = plugin.iShChConfig;
